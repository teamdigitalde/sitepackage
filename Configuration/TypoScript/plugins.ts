...
tt_content.gridelements_pi1.20.10.setup {
	...
	1 {
		...
		cObject {
			file = EXT:sitepackage/Resources/Private/Templates/ContentElements/70-30.html
		}
	}
	### 2spaltig Text 30/70
	...
	2 {
		cObject = FLUIDTEMPLATE
		cObject {
			file = EXT:sitepackage/Resources/Private/Templates/ContentElements/30-70.html
		}
	}
	### 2spaltig Text 50/50
	...
	3 {
		cObject = FLUIDTEMPLATE
		cObject {
			file = EXT:sitepackage/Resources/Private/Templates/ContentElements/50-50.html
		}
	}
	...
	4 {
		cObject = FLUIDTEMPLATE
		cObject {
			file = EXT:sitepackage/Resources/Private/Templates/ContentElements/33-33-33.html
		}
	}
	...
	5 {
		cObject = FLUIDTEMPLATE
		cObject {
			file = EXT:sitepackage/Resources/Private/Templates/ContentElements/25-25-25-25.html
		}
	}
	### 5spaltig Text 20/20/20/20/20
	6 < lib.gridelements.defaultGridSetup
	6 {
		cObject = FLUIDTEMPLATE
		cObject {
			file = EXT:sitepackage/Resources/Private/Templates/ContentElements/20-20-20-20-20.html
		}
	}
	### 100% Container
	...
	7 {
		cObject = FLUIDTEMPLATE
		cObject {
			file = EXT:sitepackage/Resources/Private/Templates/ContentElements/100.html
		}
	}
}
...
# Render navigation using fluid
	cObject = FLUIDTEMPLATE
	cObject {
		file = EXT:sitepackage/Resources/Private/Templates/ContentElements/Tabs.html
	}
	...
	innerWrap.cObject {
		...
		10 {
			...
			typolink {
				...
				ATagParams = data-target="#collapse-{field: uid}" class="accordion-toggle" data-toggle="collapse" data-parent="#collapsible-{field: parentgrid_uid}"
...
plugin.tx_indexedsearch {
	view {
		templateRootPaths {
			10 = EXT:sitepackage/Resources/Private/Templates/Indexed_search/
		}
		layoutRootPaths {

		}
		partialRootPaths {
			10 = EXT:sitepackage/Resources/Private/Partials/Indexed_search/
		}
	}
}
