...
menu.breadcrumb = COA
menu.breadcrumb.wrap = <ol class="breadcrumb" aria-labelledby="breadcrumblabel">|</ol>
...
menu.breadcrumb.20 {
  ...
  1 {
    ...
    NO.wrapItemAndSub = <li aria-current="page" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="first breadcrumb-item">|</li>|*|<li aria-current="page" itemscope itemtype="http://data-vocabulary.org/Breadcrumb" class="breadcrumb-item">|</li>|*|<li aria-current="page" class="last breadcrumb-item" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">|</li>
    ...
    CUR.linkWrap = <li aria-current="page" class="breadcrumb-item" class="current" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">|</li>
    #CUR.doNotLinkIt = 1
  }
}
...
[globalVar = GP:tx_news_pi1|news > 0]
  menu.breadcrumb {
    ...
    20.1.NO.allWrap = <li class="breadcrumb-item" itemscope itemtype="http://data-vocabulary.org/Breadcrumb">|</li>
    20.1.CUR {
